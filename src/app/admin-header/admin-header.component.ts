   ...
   approveMiniUnit(value2: string) {
    ...
    this.userService.approveMini(this.model) 
      .subscribe(
        ...
        console.log("Mini Tree New Invoice Number --->"+this.user.memberNumber);
        if(this.user.status=="good"){
          if(this.user.memberNumber == null){
            this.publicUnitApprove='block';
          }else{
            this.miniUnit3outApprove = 'block';
          }
